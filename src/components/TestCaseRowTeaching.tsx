              ...
              <div className="space-y-2">
                <div>
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-base text-gray-500 italic w-[200px] text-right flex-shrink-0 whitespace-nowrap overflow-hidden">{getImpactLabel(testCase.impact ?? 3)}</span>
                  </div>
                  <input
                    type="range"
                    min="1"
                ...
                <div>
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-base text-gray-500 italic w-[200px] text-right flex-shrink-0 whitespace-nowrap overflow-hidden">{getProbabilityLabel(testCase.probOfUse ?? 3)}</span>
                  </div>
                  <input
                    type="range"
                    min="1"
              ...
              <div className="space-y-2">
                <div>
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-base text-gray-500 italic w-[200px] text-right flex-shrink-0 whitespace-nowrap overflow-hidden">{getDistinctnessLabel(testCase.distinctness ?? 3)}</span>
                  </div>
                  <input
                    type="range"
                    min="1"
