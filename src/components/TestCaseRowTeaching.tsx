  ...
  if (isCollapsed) {
    return (
      <>
        <tr 
          onClick={() => handleToggleCollapse(false)}
          className={`border-b transition-all cursor-pointer ${isHighlighted ? 'bg-blue-100' : testCase.isDescoped ? 'bg-gray-100 opacity-60 hover:bg-gray-200' : 'bg-white hover:bg-gray-50'}`}
        >
