      ...
      <Card className="max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <CardHeader className="border-b-4 border-black bg-blue-100">
          <div className="flex items-center justify-between">
            <CardTitle className="uppercase">State Diagram Changes</CardTitle>
            <Button
              variant="ghost"
              size="icon"
              onClick={onCancel}
        ...
        <div className="p-6 border-b-4 border-black bg-gray-50">
          <h3 className="text-lg font-black uppercase mb-4">Summary</h3>
          <div className="grid grid-cols-4 gap-4">
            {/* Added States */}
            <div className="border-brutal bg-green-100 p-4">
              ...
              <p className="text-sm font-bold text-green-900 uppercase">Added</p>
            </div>

            {/* Modified States */}
            <div className="border-brutal bg-yellow-100 p-4">
              <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-sm font-bold text-yellow-900 uppercase">Modified</p>
            </div>

            {/* Removed States */}
            <div className="border-brutal bg-red-100 p-4">
              <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-sm font-bold text-red-900 uppercase">Removed</p>
            </div>

            {/* Unchanged States */}
            <div className="border-brutal bg-gray-100 p-4">
              <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-sm font-bold text-gray-900 uppercase">Unchanged</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <h3 className="text-lg font-black uppercase mb-4">Detailed Changes</h3>
          ...
          {totalChanges === 0 ? (
            ...
            <div className="space-y-4">
              ...
              {diff.added.length > 0 && (
                <div>
                  <h4 className="font-black text-green-700 uppercase mb-2 flex items-center gap-2">
                  ...
                  <div className="space-y-2">
                    {diff.added.map(stateId => {
                      ...
                      return (
                        <div
                          key={stateId}
                          className="border-brutal bg-green-50 p-4 border-l-4 border-l-green-500"
                        >
                          <p className="font-bold text-green-900">{stateId}</p>
                          {state.description && (
              ...
              {diff.modified.length > 0 && (
                <div>
                  <h4 className="font-black text-yellow-700 uppercase mb-2 flex items-center gap-2">
                    ...
                    {diff.modified.map(modification => {
                      ...
                      return (
                        <div
                          ...
                          className="border-brutal bg-yellow-50 p-4 border-l-4 border-l-yellow-500"
                        >
                          <p className="font-bold text-yellow-900">{modification.stateId}</p>
                          {state.description && (
              ...
              {diff.removed.length > 0 && (
                <div>
                  <h4 className="font-black text-red-700 uppercase mb-2 flex items-center gap-2">
                  ...
                  <div className="space-y-2">
                    {diff.removed.map(stateId => (
                      <div
                        key={stateId}
                        className="border-brutal bg-red-50 p-4 border-l-4 border-l-red-500"
                      >
                        <p className="font-bold text-red-900 line-through">{stateId}</p>
